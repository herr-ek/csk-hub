...
- [`src/features/posts/README.md`](../src/features/posts/README.md): how to add a node, mark, or editing behavior to the Post editor, and why adding one is a decision about the stored Markdown rather than an editor setting.
...
Keep Drizzle schema files split by ownership under `src/core/db/schema`.
