...
CREATE TABLE "direct_conversation" (
	...
	CONSTRAINT "directConversation_member_pair_order_check" CHECK ("direct_conversation"."first_member_id" COLLATE "C" < "direct_conversation"."second_member_id" COLLATE "C")
);
--> statement-breakpoint
